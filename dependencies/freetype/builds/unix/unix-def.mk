...
#
prefix       := /home/fonsi/proyectos/textus/dependencies/freetype/release
exec_prefix  := ${prefix}
...
LIBSSTATIC_CONFIG          := -lfreetype -lz -lbz2 -lpng16 -lm -lz -lm -lz -lharfbuzz -pthread -lm -lfreetype -lbz2 -lz -lpng16 -lm -lz -lm -lz -lbrotlidec -lbrotlicommon -lglib-2.0 -lm -pthread -lsysprof-capture-4 -pthread -lpcre2-8 -lgraphite2 -lbrotlidec -lbrotlicommon
build_libtool_libs         := 
ft_version                 := 25.0.19
